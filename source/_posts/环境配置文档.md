...
![](../images/17033345953309.jpg)
### CUDA安装
1. 下载完成后得到一个大概3g的安装包，打开进行安装，选择一个临时目录进行解压，点击ok
 ![](../images/17033345953432.jpg)
 2. 等待解压完成
 ![e739ad870e39186a7670abc870efea87](../images/e739ad870e39186a7670abc870efea87.png)
3. 解压完成后进入安装界面，这里也需要等待
![1eae4dbb378116c4c1b66fa3737e05af](../images/1eae4dbb378116c4c1b66fa3737e05af.png)
4. 点击同意并继续
![](../images/17033345953616.jpg)

5. 点击自定义后点击下一步
 ![](../images/17033345953751.jpg)
6. 展开CUDA选项取消勾选`Visual Studio Integration`，如图所示，其余不动，点击下一步
 ![](../images/17033345953843.jpg)
7. 安装位置不需要修改，直接点击下一步
 ![](../images/17033345953942.jpg)
8. 等待安装结束即可
![](../images/17033345954036.jpg)

## cuDNN
### 压缩包下载
1. **cuDNN**和**CUDA**是配套的，需要下载相对应的版本，进入[cuDNN官网](https://developer.nvidia.com/cudnn)
![](../images/17033345954133.jpg)
2. 需要**注册账号**后才能进行下载
![](../images/17033345954233.jpg)
3. 注册好账号之后点击`Download cuDNN Library`按钮进入下图的下载界面
![](../images/17033345954334.jpg)
4. **同意协议**后，选择`for CUDA 12.x`进行下一个界面
![](../images/17033345954434.jpg)
5. 这里选择第一个`Local install for Windows(Zip)`进行下载
![](../images/17033345954537.jpg)
### cuDNN安装
1. 下载完成后得到一个压缩包
 ![](../images/17033345954639.jpg)
2. 解压该压缩包可以看到其中有三个文件夹
 ![](../images/17033345954741.jpg)
3. 选择三个文件夹`bin`、`include`、`lib`并复制到CUDA的安装目录，默认目录为
```
C:\Program Files\NVIDIA GPU Computing Toolkit\CUDA\v12.1
```
![](../images/17033345954846.jpg)
复制过程中出现弹窗，选择**替换**即可
4. 将CUDA添加到**环境变量**中
- 按WIN+R，打开【运行】对话框。 输入sysdm.cpl，点【确定】按钮，点开高级选项卡，点开环境变量
 ![](../images/17033345954950.jpg)
...
![](../images/17033345955251.jpg)
### 安装与配置
#### 安装
1. 打开下载好的安装包进行安装步骤
 ![](../images/17033345955377.jpg)
2. 点击`Next`进入下一步
![](../images/17033345955499.jpg)
3. 点击`I Agree`同意协议
![](../images/17033345955616.jpg)
4. 保持默认选择`Just Me`，点击下一步
![](../images/17033345955769.jpg)
5. 这里可以选择其他安装位置，最好是默认的
![](../images/17033345955885.jpg)
...
![](../images/17033345956835.jpg)
2. 打开后执行以下命令
```powershell
conda init
```
![](../images/17033345957003.jpg)
